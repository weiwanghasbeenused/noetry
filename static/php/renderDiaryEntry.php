...
function renderDiaryEntry($diary, $idx=-1){
    ...
    $output = '<div class="' . implode(' ', $cls) . '" style="'.$style.'">' .$background.$tangled . '<div class="diary-content "><div class="entry-header entry-time diary-time small bold">'.$diary['time'].'</div>
